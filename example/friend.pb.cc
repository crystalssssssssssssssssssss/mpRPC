...
extern PROTOBUF_INTERNAL_EXPORT_friend_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode1_friend_2eproto;
namespace fixbug {
class ResultCode1DefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ResultCode1> _instance;
...
static void InitDefaultsscc_info_ResultCode1_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode1_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ResultCode1_friend_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_ResultCode1_default_instance_),
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "endListRequest\022\017\n\007user_id\030\001 \001(\r\"^\n\025GetFr"
  "iendListResponse\022\017\n\007friends\030\001 \003(\014\022#\n\006res"
  "ult\030\002 \001(\0132\023.fixbug.ResultCode1\022\017\n\007succes"
  "s\030\003 \001(\0102g\n\027GetFriendListServiceRpc\022L\n\rGe"
  "tFriendList\022\034.fixbug.GetFriendListReques"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  &descriptor_table_friend_2eproto_initialized, descriptor_table_protodef_friend_2eproto, "friend.proto", 325,
...
void ResultCode1::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResultCode1_friend_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  errcode_ = 0;
}
...
const char* ResultCode1::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode1::_InternalSerialize(
...
void ResultCode1::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.ResultCode1)
  GOOGLE_DCHECK_NE(&from, this);
  const ResultCode1* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ResultCode1>(
          &from);
  if (source == nullptr) {
...
void ResultCode1::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
::PROTOBUF_NAMESPACE_ID::Metadata ResultCode1::GetMetadata() const {
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode1*>(
      ::fixbug::ResultCode1::internal_default_instance());
}
class GetFriendListResponse::_Internal {
 public:
  static const ::fixbug::ResultCode1& result(const GetFriendListResponse* msg);
};
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListResponse)
  ...
  if (from.has_result()) {
    _internal_mutable_result()->::fixbug::ResultCode1::MergeFrom(from._internal_result());
  }
  if (from.success() != 0) {
...
GetFriendListServiceRpc::~GetFriendListServiceRpc() {}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GetFriendListServiceRpc::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GetFriendListServiceRpc::GetDescriptor() {
  return descriptor();
}

void GetFriendListServiceRpc::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void GetFriendListServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& GetFriendListServiceRpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& GetFriendListServiceRpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
GetFriendListServiceRpc_Stub::GetFriendListServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
GetFriendListServiceRpc_Stub::GetFriendListServiceRpc_Stub(
...
void GetFriendListServiceRpc_Stub::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
